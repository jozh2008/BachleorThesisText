...
% -----------------------------------------------------------------------------------
% Author
\author{Joshua Scheler}
\matrikelnr{5151402}

% -----------------------------------------------------------------------------------
% English chair and thesis info
% -----------------------------------------------------------------------------------
\institute{IFF -- Department of Computer Science}
\chair{Bioinformatics Group Freiburg}

\thesisType{Bachelors's Thesis}
\thesisTitle{Creation of a \LaTeX~Template for\\Students to use for Their Thesis}
\submitDate{March 10, 2024}  %Use \today for the date of compilation
\editingTime{July 13, 2024 - March 10, 2024}

% Examiners
\firstExaminer{Prof. Dr. Stefan Rupitsch}
\firstExaminerDepartment{IFF -- Department of Computer Science}
\firstExaminerChair{Laboratory for Electrical Instrumentation and Embedded Systems}

\secondExaminer{Prof. Dr. Max Doe}
\secondExaminerDepartment{IFF -- Department of Computer Science}
